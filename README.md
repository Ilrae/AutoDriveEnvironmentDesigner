...
최신 Windows 배포본은 독립 공개 저장소의 GitHub Releases에서 받을 수 있습니다.

- 공개 저장소: [Ilrae/AutoDriveEnvironmentDesigner](https://github.com/Ilrae/AutoDriveEnvironmentDesigner)
- 릴리스 페이지: [GitHub Releases](https://github.com/Ilrae/AutoDriveEnvironmentDesigner/releases)
- 제공 자산
  - `Windows Setup`
